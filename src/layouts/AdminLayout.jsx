...
import { 
  ...
  Search, Bell, Settings, Download, GraduationCap,
        ...
        <main className="flex-1 overflow-y-auto p-[30px_30px_0_30px] flex flex-col">
          ...
          <div className="mb-[20px] flex items-center justify-between shrink-0">
            ...
            <div className="flex gap-2.5">
              <button className="flex items-center gap-2 rounded-[10px] border border-[#cbd5e1] bg-white px-[18px] py-[10px] text-[12px] font-semibold text-[#64748b] transition-all hover:bg-[#f8fafc] hover:scale-[1.02]">
                <Download size={14} /> Export
              </button>
              <button className="flex items-center gap-2 rounded-[10px] bg-[#3d6c8a] px-[18px] py-[10px] text-[12px] font-semibold text-white transition-all hover:opacity-90 hover:scale-[1.02] shadow-md">
